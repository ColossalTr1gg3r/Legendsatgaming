            ...
            <form class="col s12" action="insert.php" method="post">
                <div class="row">
                    <div class="input-field col s6" required>
                        ...
                        <input id="icon_prefix" type="text" class="validate" required name="first_name" id="firstName">
                        <label for="icon_prefix">First Name</label>
                    </div>
                    <div class="input-field col s6" required>
                        <i class="material-icons prefix">account_circle</i>
                        <input id="icon_prefix1" type="tel" class="validate" required name="last_name" id="lastName">
                        <label for="icon_prefix1">Last Name</label>
                    </div>
                         <div class="input-field col s12" >
                        <i class="material-icons prefix">accessibility</i>
                     <select class="initialized" name="gender" id="gender">
                     ...
                     <div class="input-field col s12">
                      ...
                      <div class="input-field col s12">
                          ...
                          <input id="icon_business3" type="text" class="validate" required name="spokenlang" id="spokenLang">
                          <label for="icon_business3" data-error="wrong" data-success="right">Spoken Languages</label>
                      </div>
                      <div class="input-field col s12">
